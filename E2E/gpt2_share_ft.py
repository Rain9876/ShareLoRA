...
if __name__ == '__main__':
    ...
    def print_trainable_parameters(model):
        ...
        for n, p in model.named_parameters():
            ...
            if p.requires_grad:
                print(f"Trainable parameter {n:<20} | {p.numel():>5} parameters")
                trainable_params += p.numel()

            #if ("lora" in name and "attention" in name):
            #    param.requires_grad = require_grad
                    #if "lora_A" in name:
                    #    param.requires_grad = False
                    #if "transform.0." in name:
                    #    param.requires_grad = False
        print(
    ...
    print_trainable_parameters(lm_net)
    print(lm_net)
