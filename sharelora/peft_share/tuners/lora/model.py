    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        **optional_kwargs,
        ...
        # optional_kwargs["share_weights"] = self.share_weights[target_name]
        ...
        kwargs = {
            ...
            "share_weights": self.share_weights[target_name] if target_name in self.share_weights else None
        }
    ...
    def _replace_module(self, parent, child_name, new_module, child):
        ...
        for name, module in new_module.named_modules():
            if (self.prefix in name) or ("ranknum" in name):
                # For Shared Module
                if ("q_proj" in child_name or "v_proj" in child_name or  "k_proj" in child_name) and "lora_A" in name:
                    module.to("cuda:0")
                    #print(f"show: {name}")
                    continue
